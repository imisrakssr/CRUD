  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        ...
        <h1 class="mb-3">Showing Deleted Users</h1>
        ...
        <table id="usersData" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            $all_users_sql = "SELECT * FROM users WHERE u_status=0 ORDER BY u_id DESC";
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Do you want to delete this user permanently?</h5>
                    </div>
                    <div class="modal-body">
                      <div class="btn btn-group">
                        <a href="trash.php?delid=<?php echo $u_id; ?>" class="btn btn-danger">Yes</a> 
                      </div>
        ...
        if(isset($_GET['delid'])){
          ...
          $delete_sql = "DELETE FROM users WHERE u_id='$deleteID'";
